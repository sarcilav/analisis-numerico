...
Estos son la razón de este documento, la idea es que a partir de los conocimientos
 que podamos ir construyendo podamos al final de este encontrar una solución algorítmica
 y numérica a este problema, tan poco trabajo en los cursos introductorios al análisis numérico.

De hecho este caso particular es de los más útiles puesto que casi todo en la realidad esta definido como un cuerpo en 3D cerrado, por obvias razones, y que si los proyectáramos sobre 2D,  lo obtendríamos seria una curva compuesta y tal vez extraña, para definir la bajo una sola función, pero al fin y al cabo cerrada.
...
\\
\\
Pasando por un spline cúbico.
\\
\\
\includegraphics[scale=0.7]{img/b-spline_5}

\section*{Seudocódigo}
A continuación presentaremos dos versiones y/o aproximaciones a splines para curvas cerradas.
\subsection*{Versión 1}
\input{seudo_arcila}

\section*{Análisis de complejidad}
A continuación presentaremos las revisiones de la complejidad de las 2 versiones.
\subsection*{Versión 1}
